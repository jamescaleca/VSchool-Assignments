function getData(){
    axios.get("https://api.vschool.io/jamescaleca/todo")
...
function listData(data){
    ...
    for(let i = 0; i < data.length; i++){
        ...
        completed.addEventListener('change', function(e){
            ...
            if (this.checked) {
                axios.put(`https://api.vschool.io/jamescaleca/todo/${data[i]._id}`, {'completed': true})
                    .then(res => console.log(res))
                    .catch(err => console.log(err))
                h2.style.textDecoration = 'line-through'
            } else {
                axios.put(`https://api.vschool.io/jamescaleca/todo/${data[i]._id}`, {'completed': false})
                    .then(res => getData())
                    .catch(err => console.log(err))
        ...
        deleteItem.addEventListener('click', function(e) {
            ...
            axios.delete(`https://api.vschool.io/jamescaleca/todo/${data[i]._id}`)
                .then(res => getData())
                .catch(err => console.log(err))
        })
        ...
        editItem.addEventListener('click', function(e) {
            ...
            submitEdit.addEventListener('click', function(e) {
                ...
                axios.put(`https://api.vschool.io/jamescaleca/todo/${data[i]._id}`, {
...
todoForm.addEventListener("submit", function(e){
    ...
    axios.post("https://api.vschool.io/jamescaleca/todo", newTodo)
        .then(res => getData())
        .catch(err => console.log(err))
})